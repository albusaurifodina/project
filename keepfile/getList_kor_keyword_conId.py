...
사진없는 항목 제외된 리스트
{keyword}_korS_total_conId.csv'

사진없는 항목 리스트
{keyword}_korS_skipped_conId.csv'
...
def collect_all_pages():
    ...
    filename = f'csvlist/{keyword}_korS_total_conId.csv'
    skipped_filename = f'csvlist/{keyword}_korS_skipped_conId.csv'
