'''
getList_kor_Detail.py  / ''http://apis.data.go.kr/B551011/KorService1/detailImage1'

국문관광정보 컨텐츠 아이디에 해당하는 상세 이미지 URL 목록을 조회하여 .csv 로 저장하는 파일

contentId = 검색할 컨텐츠 아이디
keyword1 = '검색키워드'
keyword2 = '컨텐츠 아이디 타이틀'

생성파일 filename = f'list/{키워드}_{컨텐츠 아이디}_korD{검색 페이지 번호}.csv'
...
if list_Data:
    ...
    # CSV로 저장
    filename = f'list/{keyword}_{contentId}_korD{pageNumber}.csv'
