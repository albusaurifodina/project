...
include_keywords = {'getList_'}        # 파일명에 포함된 키워드

# 이름 변경 설정
rename_enabled = True
rename_mode = "replace"  # "prefix", "suffix", "replace"
rename_value = "list_getList_"  # 접두사/접미사 혹은 교체할 단어
replace_from = "list_getList_"       # replace 모드에서 바꿀 단어
replace_to = "list_"         # replace 모드에서 교체할 단어
